...
local myFirstSnippet = s("myFirstSnippet", { -- trigger text
    t("Hi! This is my first snippet in luasnip"), -- text node
    i(1, "placeholder_text"), -- insert node
    t("this is another text node"),
    t( { "", "this is another text node"} ), -- newline
})
