...
_G.packer_plugins = {
  ...
  ["aw-watcher-vim"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/aw-watcher-vim",
  ...
  catppuccin = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["git-messenger.vim"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/git-messenger.vim",
  ...
  harpoon = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["neovim-ayu"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/neovim-ayu",
    url = "https://github.com/Shatur/neovim-ayu"
  },
  ["nightfox.nvim"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  ["nvim-dap"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/nvim-dap",
  ...
  ["suda.vim"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/suda.vim",
  ...
  ["vim-browser-search"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/vim-browser-search",
  ...
  ["vim-repeat"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/vim-repeat",
