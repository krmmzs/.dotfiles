...
_G.packer_plugins = {
  ...
  ["blamer.nvim"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/blamer.nvim",
  ...
  ["indent-blankline.nvim"] = {
    loaded = true,
    path = "/home/mouzaisi/.local/share/nvim/site/pack/packer/start/indent-blankline.nvim",
